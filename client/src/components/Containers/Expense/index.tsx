...
const Expense: React.FC<{}> = () => {
    ...
    const handleOnChangeAddExpense = (name: string, value: string) => setNewExpense({ ...newExpense, [name]: value });
    ...
    const handleDateChangeAddExpense = (value: Date | null) => setNewExpense({ ...newExpense, expense_date: value });
    ...
    const handleOnChangeEditExpense = (name: string, value: string) => setExpenseSelected({ ...expenseSelected, [name]: value });
    ...
    const handleDateChangeUpdateExpense = (value: Date | null) => setExpenseSelected({ ...expenseSelected, expense_date: value });
