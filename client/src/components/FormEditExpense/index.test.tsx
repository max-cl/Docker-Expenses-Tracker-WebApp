...
import FormEditExpense from './index';

describe('FormEditExpense Component', () => {
    ...
    beforeEach(() => {
        renderComponent = render(
            <FormEditExpense
                expenseSelected={mockExpenseSelected}
    ...
    it('should render a FormEditExpense ', () => {
        const form = renderComponent.getByText('Update');
        expect(form).toBeDefined();
    });

    it('should render a FormEditExpense and click it', async () => {
    ...
    it('should render a FormEditExpense and onChange', async () => {
    ...
    it('should render a FormEditExpense and onChange Date', async () => {
        const getByName = queryByAttribute.bind(null, 'name');
    ...
    it('should render a FormEditExpense and select an category', async () => {
        const getByName = queryByAttribute.bind(null, 'name');
